...
export default class Tree extends Shape {
  
  draw(ctx) {    
    const width = 512;
    const height = 512;
    const resizeFactor = 0.3;
    ctx.drawImage(document.querySelector('#tree'), this.x - width * resizeFactor/2, this.y  - height * resizeFactor/2, width * resizeFactor, height * resizeFactor);
